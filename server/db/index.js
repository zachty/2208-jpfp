...
const syncAndSeed = async () => {
    ...
    //seed students
    const arby = await Student.create({
        firstName: 'Arby',
        lastName: 'Halo',
    ...
    const chief = await Student.create({
        firstName: 'Master',
        lastName: 'Chief',
    ...
    const doom = await Student.create({
        firstName: 'Doom',
        lastName: 'Guy',
    ...
    const snow = await Student.create({
        firstName: 'Jon',
        lastName: 'Snow',
    ...
    const wall = await Campus.create({
        name: 'The Wall',
        imageUrl:
    ...
    const hell = await Campus.create({
        name: 'Hell',
        imageUrl:
